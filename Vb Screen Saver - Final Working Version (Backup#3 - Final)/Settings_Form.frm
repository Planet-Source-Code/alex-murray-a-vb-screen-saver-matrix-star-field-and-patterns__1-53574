...
If Val(Mid$(Combo1.Text, 1, 2)) > 27 Or Val(Mid$(Combo1.Text, 1, 2)) < 1 Then Combo1.Text = "01 - "
Print #1, Str$(Val(Mid$(Combo1.Text, 1, 2)) - 1)
Print #1, Str$(HScroll1.Value)
Print #1, Str$(HScroll2.Value)
If Val(Mid$(Combo2.Text, 1, 2)) > 3 Or Val(Mid$(Combo2.Text, 1, 2)) < 1 Then Combo2.Text = "01 - "
Print #1, Str$(Val(Mid$(Combo2.Text, 1, 2)))
...
If C$ = "" Then C$ = "15"
If D$ = "" Then D$ = "1"
If Val(A$) > 26 Or Val(A$) < 0 Then A$ = "0"
If Val(B$) > 10 Or Val(B$) < 1 Then B$ = "3"
If Val(C$) > 30 Or Val(C$) < 1 Then C$ = "15"
If Val(D$) > 3 Or Val(D$) < 1 Then D$ = "1"
